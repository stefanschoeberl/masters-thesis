...
\lstinputlisting[label = {lst:minijava-compilation-task}, caption = {Gradle-Task zum Kompilieren von MiniJava-Quelltexten}]{src/testenGradle/MiniJavaCompilationTask.groovy}
...
\lstinputlisting[label = {lst:buildSrc-structure}, caption = {Aufbau des buildSrc-Moduls}]{src/testenGradle/buildSrc.txt}
...
\pagebreak
\lstinputlisting[label = {lst:demo-nodejs-index-js}, caption = {index.js}]{src/testenGradle/index.js}
